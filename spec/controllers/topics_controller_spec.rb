...
RSpec.describe TopicsController, type: :controller do
    ...
    #################### GUEST ####################
    #Can read anything but cannot do anything else until they sign up#
  ...
  context "guest" do
    ...
    #################### MEMBERS ####################
    #Create, Update, or delete only their own posts#
  ...
  context "member user" do
    ...
    describe "DELETE destroy" do
      ...
      #################### ADMIN ####################
      #Create, update, or delete any topic or post#
  ...
  #       #################### MODERATORS ####################
  #     # Can update, but not create or delete, existing topics.
